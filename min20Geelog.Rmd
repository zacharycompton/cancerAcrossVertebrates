...
Data<- left_join(Data, Data2, by = "Species")
```
#adult weight neo
```{r}
...
adultWeight<-log(cutData$adult_weight.y)
NeoplasiaOccurences<-cutData$NeoplasiaWithDenominators.x
NonOccurences<-(cutData$RecordsWithDenominators.x-cutData$NeoplasiaWithDenominators.x)
...
max_longevity.months.<-log(cutData$max_longevity.months.)
...
Gestation<-log(cutData$Gestation.months.)
NeoplasiaOccurences<-cutData$NeoplasiaWithDenominators
NonOccurences<-(cutData$RecordsWithDenominators-cutData$NeoplasiaWithDenominators)
...
Gestation<-log(cutData$Gestation.months.)
Longevity<-log(cutData$max_longevity.months.)
Mass<-log(cutData$adult_weight.g.)
NeoplasiaOccurences<-cutData$NeoplasiaWithDenominators
NonOccurences<-(cutData$RecordsWithDenominators-cutData$NeoplasiaWithDenominators)
...
Gest+Mass Neo
```{r}
cutData <- Data[,c(1,5,9,10,11,12,30,38,42),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
compar<-compar.gee(cbind(NeoplasiaOccurences, NonOccurences) ~Gestation+Mass, phy = pruned.tree, family = "binomial")
compar
```
Gest+Mass Mal
```{r}
cutData <- Data[,c(1,5,9,10,11,16,30,38,42),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
compar<-compar.gee(cbind(MalignancyOccurences, NonOccurences) ~Gestation+Mass, phy = pruned.tree, family = "binomial")
compar
```
...
adultWeight<-log(cutData$adult_weight.g.)
NeoplasiaOccurences<-cutData$NeoplasiaWithDenominators
NonOccurences<-(cutData$RecordsWithDenominators-cutData$NeoplasiaWithDenominators)
...
max_longevity.months.<-log(cutData$max_longevity.months.)
MalignancyOccurences<-cutData$NeoplasiaWithDenominators
NonOccurences<-(cutData$RecordsWithDenominators-cutData$NeoplasiaWithDenominators)

#recompute branch lengths
tree2<-compute.brlen(phy=pruned.tree,method="Grafen",power=0.5)


compar<-compar.gee(cbind(MalignancyOccurences, NonOccurences) ~max_longevity.months., phy = tree2, family = "binomial")
compar
...
compar<-compar.gee(cbind(NeoplasiaOccurences, NonOccurences) ~Gestation, phy = tree2, family = "binomial")
compar
...
compar<-compar.gee(cbind(MalignancyOccurences, NonOccurences) ~Gestation, phy = tree2, family = "binomial")
compar
```
...
compar<-compar.gee(cbind(NeoplasiaOccurences, NonOccurences) ~Gestation+Longevity+Mass, phy = tree2, family = "binomial")
compar
```
...
compar<-compar.gee(cbind(MalignancyOccurences, NonOccurences) ~Gestation+Longevity+Mass, phy = tree2, family = "binomial")
compar
```
