...
Age <- read.csv("allrecords.csv")


highest_age_per_species <- Age %>%
  filter(age_months != -1 & !is.na(age_months)) %>%  # Exclude -1 and NA values
  group_by(Species) %>%
...
##BMR models
#bmr neo
cutData <- Data[,c(1,6,9,10,11,13,41,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
cutData <- Data[,c(1,6,9,10,11,17,41,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#wxl neo
cutData <- Data[,c(1,6,9,10,11,13,40,38,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#wxl mal
cutData <- Data[,c(1,6,9,10,11,17,40,38,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
cutData <- Data[,c(1,6,9,10,11,13,34,42,43),drop=FALSE] 
...
#litter per year mal
cutData <- Data[,c(1,6,9,10,11,17,34,42,43),drop=FALSE] 
cutData <- cutData[!(cutData$common_name %in% c("Dwarf caimen","Agassiz's desert tortoise","Egyptian snouted cobra","Mangrove snake","Tiger rat snake","Madagscar tree boa")),]
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
####Female Maturity neo
cutData <- Data[,c(1,6,9,10,11,13,28,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#Female Maturity Mal
cutData <- Data[,c(1,6,9,10,11,17,28,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
####Male Maturity neo
cutData <- Data[,c(1,6,9,10,11,13,29,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#Male Maturity Mal
cutData <- Data[,c(1,6,9,10,11,17,29,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#Weaning Weight neo
cutData <- Data[,c(1,6,9,10,11,13,37,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#Weaning Weight Mal
cutData <- Data[,c(1,6,9,10,11,17,37,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#Growth Rate Neo
cutData <- Data[,c(1,6,9,10,11,13,39,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
#Growth Rate Mal
cutData <- Data[,c(1,6,9,10,11,17,39,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
cutData <- Data[,c(1,6,9,10,11,13,38,30,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
cutData <- Data[,c(1,6,9,10,11,17,38,30,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
cutData <- Data[,c(1,6,9,10,11,13,40,30,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
...
cutData <- Data[,c(1,6,9,10,11,17,40,30,42,43),drop=FALSE] 
cutData[cutData < 0] <-NA
cutData <- na.omit(cutData)
tree <- read.tree("min20Fixed516.nwk")
